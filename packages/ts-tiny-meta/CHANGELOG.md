...
- [#295](https://github.com/dadajam4/fastkit/pull/295) [`f007e40`](https://github.com/dadajam4/fastkit/commit/f007e4056e9a7d2844bd1e5644c4787fc87fdaab) Thanks [@dadajam4](https://github.com/dadajam4)! - Stop handing a symbol reference over as a URL, and carry a preview of what it
  resolves to instead.
...
- [#272](https://github.com/dadajam4/fastkit/pull/272) [`fe30779`](https://github.com/dadajam4/fastkit/commit/fe30779ffb7f0cb6aaa27efe8330f7e3234a3b16) Thanks [@dadajam4](https://github.com/dadajam4)! - Stop leaking comment syntax into documentation text when a comment contains a `{@link}`.
  ...
  Anything rendering these parts as markdown was getting bullet lists out of those `*` prefixes, and a fenced block inside such a comment was shattered into list items — one fragment being a bare fence with no language. That is what took `pnpm build:docs` down in this repo ([#270](https://github.com/dadajam4/fastkit/issues/270)).
...
- [#249](https://github.com/dadajam4/fastkit/pull/249) [`c777724`](https://github.com/dadajam4/fastkit/commit/c77772464f410be42b195bef8fd7b2b7f8681b25) Thanks [@dadajam4](https://github.com/dadajam4)! - Fix `@fastkit/ts-tiny-meta/client`, whose type reference never resolved.
