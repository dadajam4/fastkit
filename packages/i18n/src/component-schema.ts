 ...
 */
export type I18nComponentSchemaSettings<
 ...
 */
export interface I18nComponentSchemaImpl<
  DateTimeFormats extends I18nDateTimeFormats,
  RelativeTimeFormats extends I18nRelativeTimeFormats,
  NumberFormats extends I18nNumberFormats,
  ListFormats extends I18nListFormats,
 ...
 * component schema
 */
export interface I18nComponentSchema<
  LocaleName extends string,
  BaseLocale extends LocaleName,
  LocaleMeta extends I18nLocaleMeta,
  Translations extends I18nTranslations,
  ...
  ListFormats extends I18nListFormats,
  Dependencies extends I18nDependencies<LocaleName, BaseLocale, LocaleMeta>,
> extends I18nComponentSchemaImpl<
  DateTimeFormats,
  RelativeTimeFormats,
  NumberFormats,
  ListFormats
 ...
 */
export function defineI18nComponentSchema<
  LocaleName extends string,
  BaseLocale extends LocaleName,
  LocaleMeta extends I18nLocaleMeta,
  Translations extends I18nTranslations,
  ...
  Dependencies extends I18nDependencies<LocaleName, BaseLocale, LocaleMeta>,
>(
  settings: I18nComponentSchemaSettings<
    LocaleName,
    BaseLocale,
    LocaleMeta,
    Translations,
...
> {
  ...
  const schema: I18nComponentSchema<
    LocaleName,
    BaseLocale,
    LocaleMeta,
    Translations,
  ...
  > = {
    ...
    defineComponent: (componentSettings) =>
      defineI18nComponent({ schema, ...componentSettings }),
  };
