/**
 * @file execution condition comparator
 * @description
 * The implementation in this file is a utility implementation for comparing argument information passed to a function in order to efficiently cache the results of function execution.
 * It can be used to compare a mass of objects or arguments in JavaScript.
 * The values to be compared are basically assumed to be values that can be serialized as JSON.
 * This is because it supports keeping comparison results not only on the JavaScript runtime, but also in storage, such as Redis.
 */

import { isIterableObject } from '@fastkit/helpers';
...
/**
 * The behavior is almost the same as {@link createComparatorCondition}, but the condition object generated by this method is not lost at all.
 */
