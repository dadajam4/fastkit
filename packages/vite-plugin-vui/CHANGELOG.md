...
- Updated dependencies [[`023bebd`](https://github.com/dadajam4/fastkit/commit/023bebd6352f4bb18e6944dc72d2fd52e233e411)]:
  ...
  - @fastkit/vite-kit@1.4.3

## 3.8.0

### Minor Changes

- [#225](https://github.com/dadajam4/fastkit/pull/225) [`19c1644`](https://github.com/dadajam4/fastkit/commit/19c1644000abef24cea6218c5525fc1bd22bd125) Thanks [@dadajam4](https://github.com/dadajam4)! - Stop requiring `@fastkit/vue-page`
  ...
  **One behaviour change to check.** The generated installer no longer defaults
  ...
  `routerOptions.RouterLink` but does _not_ forward it to `installVui`, its
  ...
  **Why the default went.** Because the generated tree is written into the
  ...
  the second resolver behind [#224](https://github.com/dadajam4/fastkit/issues/224): `@fastkit/vot` already held
...
- Updated dependencies [[`02ed660`](https://github.com/dadajam4/fastkit/commit/02ed660f4e06be90dceb2664d341d67f1136fe6e)]:
  - @fastkit/vite-kit@1.4.2

## 3.7.0

### Minor Changes

- [#202](https://github.com/dadajam4/fastkit/pull/202) [`71bba8f`](https://github.com/dadajam4/fastkit/commit/71bba8fdfb1dbaeb0f337814c0f067402f294cb5) Thanks [@dadajam4](https://github.com/dadajam4)! - Stop generating an icon font by default — use the one `@fastkit/vui` now ships.
  ...
  and `.vui/vui.d.ts` no longer references a generated `icon-font/`. The icon _names_ are unchanged — same source set, same `icon-mdi-*` class names — so no project source has to change.

  `iconFont` is now the slot for adding **your own** icons to the kit. `iconFont: [{ src: './assets/icons' }]` builds those entries exactly as before, but they are generated _in addition to_ the shipped font rather than instead of it — this kit's own defaults (`menuDown: 'mdi-menu-down'`, `clear: 'mdi-close'`, twenty-odd more) are named in that font, so replacing it would have meant redefining every one of them before anything rendered. `IconName` becomes the union of both, which is exactly what is loaded at runtime.
...
- Updated dependencies [[`d63b1af`](https://github.com/dadajam4/fastkit/commit/d63b1af8bf1bb131590ff540af82428cc60aeb7e), [`cd79340`](https://github.com/dadajam4/fastkit/commit/cd793404582f7fca56798b8dc0e46eafa39bc91b)]:
  - @fastkit/tiny-logger@0.16.1
  - @fastkit/vite-kit@1.3.1
  - @fastkit/vui@1.4.1
...
- Updated dependencies []:
  - @fastkit/icon-font-gen@0.16.0-next.0
  - @fastkit/tiny-logger@0.16.0-next.0
  - @fastkit/vite-kit@1.3.0-next.0
