...
type Types = typeof import('@@@/packages/ev/typemeta/$types');

export const prefetch = createPrefetch('ev/api', async () => {
  const exports = (await import('@@@/packages/ev/typemeta/$types.json'))
    .default;
  return {
    exports,
  };
