...
type Types = typeof import('@@@/packages/vue-location/typemeta/$types');

export const prefetch = createPrefetch('vue-location/api', async () => {
  const exports = (
    await import('@@@/packages/vue-location/typemeta/$types.json')
  ).default;
  return {
    exports,
  };
